...
# The script-style checks above run in a SUBPROCESS: OBJ-09 health-checks mutates
# os.environ (HERMES_HOME / HERMES_KANBAN_DB) and (in one file)
# os.fork()s sacrificial children — none of that may leak into the pytest
