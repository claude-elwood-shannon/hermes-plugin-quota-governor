...
# ══ Merged from the root lane test_burn_watchdog.py (t_3fc3e669) ══
# Root-side bodies address the module through the `wd` alias; sys.modules
# "burn_watchdog" is already registered by the load_module() above.
