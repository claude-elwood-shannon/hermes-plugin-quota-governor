...
CRONS=(
  ...
  # P2 gobernanza: objective-lifecycle (hourly; engine + wrapper dejan tick
  # timestamped — el engine imprime el suyo, el wrapper guarda el caso en
  # que el engine muera antes de imprimir). Ajusta nice/budget de objetivos
  # no-static y loguea a objective-lifecycle.jsonl.
  "objective-lifecycle|${HERMES_HOME_DIR}/logs/objective-lifecycle.log|3600|5400|bash ${HERMES_HOME_DIR}/scripts/objective-lifecycle-cron.sh"
